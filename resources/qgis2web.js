...
map.getView().fit([-8559873.223290, -2659706.671859, -5588763.357230, -1044238.177555], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_PERIMETROSAREASPROTEGIDAS_5,
    colName: 'NOMBRE_AP_',
    zoom: 10,
    collapsed: true,
    map: map
...
document.getElementsByClassName('search-layer-input-search')[0].placeholder = 'Buscar Área Protegida ...';
