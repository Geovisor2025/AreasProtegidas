var size = 0;
var placement = 'point';
function categories_AREAS_PROTEGIDAS_CATEGORIAS_3(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'ÁREA NATURAL DE MANEJO INTEGRADO':
...
var style_AREAS_PROTEGIDAS_CATEGORIAS_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_AREAS_PROTEGIDAS_CATEGORIAS_3(feature, value, size, resolution, labelText,
